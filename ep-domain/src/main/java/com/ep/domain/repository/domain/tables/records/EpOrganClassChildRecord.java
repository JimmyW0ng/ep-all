...
public class EpOrganClassChildRecord extends UpdatableRecordImpl<EpOrganClassChildRecord> implements Record13<Long, Long, Long, Long, Integer, Integer, Integer, Boolean, Timestamp, Timestamp, String, Boolean, Long> {

    private static final long serialVersionUID = -909349310;
    ...
    /**
     * Setter for <code>ep.ep_organ_class_child.bespeaked_schedule_num</code>. 已预约数（正常班次订单为0）
     */
    public EpOrganClassChildRecord setBespeakedScheduleNum(Integer value) {
        set(6, value);
        return this;
    }

    /**
     * Getter for <code>ep.ep_organ_class_child.bespeaked_schedule_num</code>. 已预约数（正常班次订单为0）
     */
    public Integer getBespeakedScheduleNum() {
     ...
     */
    @Override
    public Row13<Long, Long, Long, Long, Integer, Integer, Integer, Boolean, Timestamp, Timestamp, String, Boolean, Long> fieldsRow() {
     ...
     */
    @Override
    public Row13<Long, Long, Long, Long, Integer, Integer, Integer, Boolean, Timestamp, Timestamp, String, Boolean, Long> valuesRow() {
    ...
    public Field<Integer> field7() {
        return EpOrganClassChild.EP_ORGAN_CLASS_CHILD.BESPEAKED_SCHEDULE_NUM;
    }
    ...
    public Integer value7() {
        return getBespeakedScheduleNum();
    }
     ...
     */
    @Override
    public EpOrganClassChildRecord value7(Integer value) {
        setBespeakedScheduleNum(value);
        return this;
    }
     ...
     */
    @Override
    public EpOrganClassChildRecord values(Long value1, Long value2, Long value3, Long value4, Integer value5, Integer value6, Integer value7, Boolean value8, Timestamp value9, Timestamp value10, String value11, Boolean value12, Long value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
