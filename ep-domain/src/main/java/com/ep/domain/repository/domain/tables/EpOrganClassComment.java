...
public class EpOrganClassComment extends TableImpl<EpOrganClassCommentRecord> {
    ...
    private static final long serialVersionUID = -687705558;
    ...
    /**
     * The column <code>ep.ep_organ_class_comment.member_id</code>. 评论者id
     */
    public final TableField<EpOrganClassCommentRecord, Long> MEMBER_ID = createField("member_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "评论者id");
