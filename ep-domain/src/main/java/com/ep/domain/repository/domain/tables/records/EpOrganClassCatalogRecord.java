...
public class EpOrganClassCatalogRecord extends UpdatableRecordImpl<EpOrganClassCatalogRecord> implements Record13<Long, Long, String, String, Integer, Timestamp, Timestamp, Integer, String, Timestamp, Timestamp, Boolean, Long> {

    private static final long serialVersionUID = -995777286;
     ...
     */
    public EpOrganClassCatalogRecord(Long id, Long classId, String catalogTitle, String catalogDesc, Integer catalogIndex, Timestamp startTime, Timestamp endTime, Integer childEvaluatedNum, String remark, Timestamp createAt, Timestamp updateAt, Boolean delFlag, Long version) {
        super(EpOrganClassCatalog.EP_ORGAN_CLASS_CATALOG);
    ...
    /**
     * Getter for <code>ep.ep_organ_class_catalog.end_time</code>. 结束时间
     */
    ...
    /**
     * Setter for <code>ep.ep_organ_class_catalog.end_time</code>. 结束时间
     */
    public EpOrganClassCatalogRecord setEndTime(Timestamp value) {
        set(6, value);
        return this;
    }

    /**
     * Getter for <code>ep.ep_organ_class_catalog.child_evaluated_num</code>. 已经评价过的孩子数量
     */
    ...
    /**
     * Setter for <code>ep.ep_organ_class_catalog.child_evaluated_num</code>. 已经评价过的孩子数量
     */
    public EpOrganClassCatalogRecord setChildEvaluatedNum(Integer value) {
        set(7, value);
        return this;
    }
    ...
    public Field<Timestamp> field7() {
        return EpOrganClassCatalog.EP_ORGAN_CLASS_CATALOG.END_TIME;
    }
    ...
    public Field<Integer> field8() {
        return EpOrganClassCatalog.EP_ORGAN_CLASS_CATALOG.CHILD_EVALUATED_NUM;
    }
     ...
     */
    @Override
    public EpOrganClassCatalogRecord value7(Timestamp value) {
        setEndTime(value);
        return this;
    }
     ...
     */
    @Override
    public EpOrganClassCatalogRecord value8(Integer value) {
     ...
     */
    @Override
    public EpOrganClassCatalogRecord values(Long value1, Long value2, String value3, String value4, Integer value5, Timestamp value6, Timestamp value7, Integer value8, String value9, Timestamp value10, Timestamp value11, Boolean value12, Long value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
