...
public class EpOrganClassCatalogRecord extends UpdatableRecordImpl<EpOrganClassCatalogRecord> implements Record13<Long, Long, String, String, Integer, Timestamp, Integer, Integer, String, Timestamp, Timestamp, Boolean, Long> {

    private static final long serialVersionUID = 2133684997;
     ...
     */
    @Override
    public Row13<Long, Long, String, String, Integer, Timestamp, Integer, Integer, String, Timestamp, Timestamp, Boolean, Long> fieldsRow() {
     ...
     */
    @Override
    public Row13<Long, Long, String, String, Integer, Timestamp, Integer, Integer, String, Timestamp, Timestamp, Boolean, Long> valuesRow() {
     ...
     */
    @Override
    public EpOrganClassCatalogRecord values(Long value1, Long value2, String value3, String value4, Integer value5, Timestamp value6, Integer value7, Integer value8, String value9, Timestamp value10, Timestamp value11, Boolean value12, Long value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EpOrganClassCatalogRecord(Long id, Long classId, String catalogTitle, String catalogDesc, Integer catalogIndex, Timestamp startTime, Integer duration, Integer childEvaluatedNum, String remark, Timestamp createAt, Timestamp updateAt, Boolean delFlag, Long version) {
        super(EpOrganClassCatalog.EP_ORGAN_CLASS_CATALOG);
