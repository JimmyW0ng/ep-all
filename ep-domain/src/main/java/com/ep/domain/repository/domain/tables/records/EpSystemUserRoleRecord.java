...
public class EpSystemUserRoleRecord extends UpdatableRecordImpl<EpSystemUserRoleRecord> implements Record8<Long, Long, Long, Long, Timestamp, Timestamp, Boolean, Long> {

    private static final long serialVersionUID = -220952087;
     ...
     */
    public EpSystemUserRoleRecord setRoleCode(Long value) {
        set(3, value);
        return this;
    }
     ...
     */
    @Override
    public Row8<Long, Long, Long, Long, Timestamp, Timestamp, Boolean, Long> fieldsRow() {
     ...
     */
    @Override
    public Row8<Long, Long, Long, Long, Timestamp, Timestamp, Boolean, Long> valuesRow() {
     ...
     */
    @Override
    public EpSystemUserRoleRecord value4(Long value) {
        setRoleCode(value);
        return this;
    }
     ...
     */
    @Override
    public EpSystemUserRoleRecord values(Long value1, Long value2, Long value3, Long value4, Timestamp value5, Timestamp value6, Boolean value7, Long value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EpSystemUserRoleRecord(Long id, Long userId, Long roleId, Long roleCode, Timestamp createAt, Timestamp updateAt, Boolean delFlag, Long version) {
        super(EpSystemUserRole.EP_SYSTEM_USER_ROLE);
