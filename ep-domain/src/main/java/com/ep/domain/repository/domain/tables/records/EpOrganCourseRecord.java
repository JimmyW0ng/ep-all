...
public class EpOrganCourseRecord extends UpdatableRecordImpl<EpOrganCourseRecord> implements Record22<Long, Long, EpOrganCourseCourseType, Long, String, String, String, BigDecimal, String, Boolean, String, String, EpOrganCourseCourseStatus, Timestamp, Timestamp, Timestamp, Integer, String, Timestamp, Timestamp, Boolean, Long> {

    private static final long serialVersionUID = 1290119931;
     ...
     */
    @Override
    public Row22<Long, Long, EpOrganCourseCourseType, Long, String, String, String, BigDecimal, String, Boolean, String, String, EpOrganCourseCourseStatus, Timestamp, Timestamp, Timestamp, Integer, String, Timestamp, Timestamp, Boolean, Long> fieldsRow() {
     ...
     */
    @Override
    public Row22<Long, Long, EpOrganCourseCourseType, Long, String, String, String, BigDecimal, String, Boolean, String, String, EpOrganCourseCourseStatus, Timestamp, Timestamp, Timestamp, Integer, String, Timestamp, Timestamp, Boolean, Long> valuesRow() {
