...
public class EpFileRecord extends UpdatableRecordImpl<EpFileRecord> implements Record11<Long, String, String, Byte, Long, Integer, Timestamp, Timestamp, String, Boolean, Long> {

    private static final long serialVersionUID = 1689061966;
     ...
     */
    public EpFileRecord(Long id, String fileName, String fileUrl, Byte bizTypeCode, Long sourceId, Integer sort, Timestamp createAt, Timestamp updateAt, String remark, Boolean delFlag, Long version) {
        super(EpFile.EP_FILE);
     ...
     */
    public EpFileRecord setBizTypeCode(Byte value) {
        set(3, value);
        return this;
    }
     ...
     */
    @Override
    public Row11<Long, String, String, Byte, Long, Integer, Timestamp, Timestamp, String, Boolean, Long> fieldsRow() {
     ...
     */
    @Override
    public Row11<Long, String, String, Byte, Long, Integer, Timestamp, Timestamp, String, Boolean, Long> valuesRow() {
     ...
     */
    @Override
    public EpFileRecord value4(Byte value) {
     ...
     */
    @Override
    public EpFileRecord values(Long value1, String value2, String value3, Byte value4, Long value5, Integer value6, Timestamp value7, Timestamp value8, String value9, Boolean value10, Long value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
