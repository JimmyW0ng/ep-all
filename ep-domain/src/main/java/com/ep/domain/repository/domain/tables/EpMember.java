...
public class EpMember extends TableImpl<EpMemberRecord> {
    ...
    private static final long serialVersionUID = 1003525108;
    /**
    ...
    /**
     * The column <code>ep.ep_member.channel</code>. 渠道来源
     */
    public final TableField<EpMemberRecord, String> CHANNEL = createField("channel", org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "渠道来源");
    /**
