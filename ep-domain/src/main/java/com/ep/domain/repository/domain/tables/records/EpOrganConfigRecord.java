...
public class EpOrganConfigRecord extends UpdatableRecordImpl<EpOrganConfigRecord> implements Record9<Long, Long, Byte, Boolean, Timestamp, Timestamp, String, Boolean, Long> {

    private static final long serialVersionUID = -1954436986;
     ...
     */
    public EpOrganConfigRecord(Long id, Long ognId, Byte weight, Boolean supportTag, Timestamp createAt, Timestamp updateAt, String remark, Boolean delFlag, Long version) {
        super(EpOrganConfig.EP_ORGAN_CONFIG);
    ...
    /**
     * Getter for <code>ep.ep_organ_config.weight</code>. 权重
     */
    ...
    /**
     * Setter for <code>ep.ep_organ_config.weight</code>. 权重
     */
    public EpOrganConfigRecord setWeight(Byte value) {
        set(2, value);
        return this;
    }
     ...
     */
    @Override
    public Row9<Long, Long, Byte, Boolean, Timestamp, Timestamp, String, Boolean, Long> fieldsRow() {
     ...
     */
    @Override
    public Row9<Long, Long, Byte, Boolean, Timestamp, Timestamp, String, Boolean, Long> valuesRow() {
    ...
    public Field<Byte> field3() {
        return EpOrganConfig.EP_ORGAN_CONFIG.WEIGHT;
    }
     ...
     */
    @Override
    public EpOrganConfigRecord value3(Byte value) {
        setWeight(value);
        return this;
    }
     ...
     */
    @Override
    public EpOrganConfigRecord values(Long value1, Long value2, Byte value3, Boolean value4, Timestamp value5, Timestamp value6, String value7, Boolean value8, Long value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
