...
public class EpConstantTag extends TableImpl<EpConstantTagRecord> {
    ...
    private static final long serialVersionUID = 1667516815;
    ...
    /**
     * The column <code>ep.ep_constant_tag.catalog_id</code>. 课程类目id
     */
    public final TableField<EpConstantTagRecord, Long> CATALOG_ID = createField("catalog_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "课程类目id");
