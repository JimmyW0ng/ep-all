...
public class EpOrganClassCatalog extends TableImpl<EpOrganClassCatalogRecord> {
    ...
    private static final long serialVersionUID = 512847513;
    ...
    /**
     * The column <code>ep.ep_organ_class_catalog.end_time</code>. 结束时间
     */
    public final TableField<EpOrganClassCatalogRecord, Timestamp> END_TIME = createField("end_time", org.jooq.impl.SQLDataType.TIMESTAMP, this, "结束时间");
