...
public class EpOrganClassCatalog extends TableImpl<EpOrganClassCatalogRecord> {
    ...
    private static final long serialVersionUID = 1028818167;
    ...
    /**
     * The column <code>ep.ep_organ_class_catalog.dura_type</code>. 时长类型:分;时;天
     */
    public final TableField<EpOrganClassCatalogRecord, EpOrganClassCatalogDuraType> DURA_TYPE = createField("dura_type", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.ep.domain.repository.domain.enums.EpOrganClassCatalogDuraType.class), this, "时长类型:分;时;天");
