...
public class EpOrgan extends TableImpl<EpOrganRecord> {
    ...
    /**
     * The column <code>ep.ep_organ.status</code>. 状态：已保存；已上线；已下线；已冻结
     */
    public final TableField<EpOrganRecord, EpOrganStatus> STATUS = createField("status", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.ep.domain.repository.domain.enums.EpOrganStatus.class), this, "状态：已保存；已上线；已下线；已冻结");
    /**
