...
public class EpOrderRecord extends UpdatableRecordImpl<EpOrderRecord> implements Record16<Long, Long, Long, Long, Long, Long, BigDecimal, EpOrderStatus, Timestamp, Timestamp, BigDecimal, Timestamp, Timestamp, String, Boolean, Long> {

    private static final long serialVersionUID = 81558281;
    ...
    /**
     * Getter for <code>ep.ep_order.status</code>. 订单状态：保存；已支付；成功；已开班；结束；拒绝；取消；
     */
    ...
    /**
     * Setter for <code>ep.ep_order.status</code>. 订单状态：保存；已支付；成功；已开班；结束；拒绝；取消；
     */
     ...
     */
    @Override
    public Row16<Long, Long, Long, Long, Long, Long, BigDecimal, EpOrderStatus, Timestamp, Timestamp, BigDecimal, Timestamp, Timestamp, String, Boolean, Long> fieldsRow() {
     ...
     */
    @Override
    public Row16<Long, Long, Long, Long, Long, Long, BigDecimal, EpOrderStatus, Timestamp, Timestamp, BigDecimal, Timestamp, Timestamp, String, Boolean, Long> valuesRow() {
     ...
     */
    @Override
    public EpOrderRecord value11(BigDecimal value) {
     ...
     */
    @Override
    public EpOrderRecord value14(String value) {
        setRemark(value);
        return this;
    }
     ...
     */
    @Override
    public EpOrderRecord value15(Boolean value) {
        setDelFlag(value);
        return this;
    }
     ...
     */
    @Override
    public EpOrderRecord value16(Long value) {
        setVersion(value);
        return this;
    }
     ...
     */
    @Override
    public EpOrderRecord values(Long value1, Long value2, Long value3, Long value4, Long value5, Long value6, BigDecimal value7, EpOrderStatus value8, Timestamp value9, Timestamp value10, BigDecimal value11, Timestamp value12, Timestamp value13, String value14, Boolean value15, Long value16) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
