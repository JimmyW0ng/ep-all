...
public class EpOrderRecord extends UpdatableRecordImpl<EpOrderRecord> implements Record19<Long, Long, Long, Long, Long, Long, BigDecimal, EpOrderStatus, EpOrderPayType, EpOrderPayStatus, Timestamp, Timestamp, Timestamp, BigDecimal, Timestamp, Timestamp, String, Boolean, Long> {

    private static final long serialVersionUID = 2000220035;
    ...
    /**
     * Getter for <code>ep.ep_order.pay_status</code>. 支付状态：已支付；退款申请中；退款完成；提现申请中；提现完成；
     */
    ...
    /**
     * Setter for <code>ep.ep_order.pay_status</code>. 支付状态：已支付；退款申请中；退款完成；提现申请中；提现完成；
     */
     ...
     */
    @Override
    public Row19<Long, Long, Long, Long, Long, Long, BigDecimal, EpOrderStatus, EpOrderPayType, EpOrderPayStatus, Timestamp, Timestamp, Timestamp, BigDecimal, Timestamp, Timestamp, String, Boolean, Long> fieldsRow() {
     ...
     */
    @Override
    public Row19<Long, Long, Long, Long, Long, Long, BigDecimal, EpOrderStatus, EpOrderPayType, EpOrderPayStatus, Timestamp, Timestamp, Timestamp, BigDecimal, Timestamp, Timestamp, String, Boolean, Long> valuesRow() {
     ...
     */
    @Override
    public EpOrderRecord value14(BigDecimal value) {
     ...
     */
    @Override
    public EpOrderRecord value17(String value) {
        setRemark(value);
        return this;
    }
     ...
     */
    @Override
    public EpOrderRecord value18(Boolean value) {
        setDelFlag(value);
        return this;
    }
     ...
     */
    @Override
    public EpOrderRecord value19(Long value) {
        setVersion(value);
        return this;
    }
