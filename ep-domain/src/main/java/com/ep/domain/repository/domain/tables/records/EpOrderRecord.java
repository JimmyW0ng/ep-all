...
public class EpOrderRecord extends UpdatableRecordImpl<EpOrderRecord> implements Record14<Long, Long, Long, Long, Long, Long, EpOrderStatus, Timestamp, Timestamp, Timestamp, Timestamp, String, Boolean, Long> {

    private static final long serialVersionUID = 351676752;
     ...
     */
    public EpOrderRecord(Long id, Long memberId, Long childId, Long ognId, Long courseId, Long classId, EpOrderStatus status, Timestamp authTime, Timestamp cancelTime, Timestamp createAt, Timestamp updateAt, String remark, Boolean delFlag, Long version) {
     ...
     */
    @Override
    public Row14<Long, Long, Long, Long, Long, Long, EpOrderStatus, Timestamp, Timestamp, Timestamp, Timestamp, String, Boolean, Long> fieldsRow() {
     ...
     */
    @Override
    public Row14<Long, Long, Long, Long, Long, Long, EpOrderStatus, Timestamp, Timestamp, Timestamp, Timestamp, String, Boolean, Long> valuesRow() {
     ...
     */
    @Override
    public EpOrderRecord value12(String value) {
        setRemark(value);
        return this;
    }
     ...
     */
    @Override
    public EpOrderRecord value13(Boolean value) {
        setDelFlag(value);
        return this;
    }
     ...
     */
    @Override
    public EpOrderRecord value14(Long value) {
        setVersion(value);
        return this;
    }
     ...
     */
    @Override
    public EpOrderRecord values(Long value1, Long value2, Long value3, Long value4, Long value5, Long value6, EpOrderStatus value7, Timestamp value8, Timestamp value9, Timestamp value10, Timestamp value11, String value12, Boolean value13, Long value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
