...
public class MessageCode {
    ...
    public static final String ERROR_COURSE_EXIST_NORMAL_ORDER = "ERROR_COURSE_EXIST_NORMAL_ORDER";
    ...
    public static final String ERROR_WECHAT_PAY_OUT_TRADE_NO_NOT_EXIST = "ERROR_WECHAT_PAY_OUT_TRADE_NO_NOT_EXIST";
    public static final String ERROR_WECHAT_PAY_OUT_TRADE_NO_SUCCESS = "ERROR_WECHAT_PAY_OUT_TRADE_NO_SUCCESS";
    public static final String ERROR_WECHAT_PAY_REFUND_FAIL = "ERROR_WECHAT_PAY_REFUND_FAIL";
    public static final String ERROR_WECHAT_PAY_REFUND_REQ_INFO = "ERROR_WECHAT_PAY_REFUND_REQ_INFO";
    public static final String ERROR_WECHAT_PAY_REFUND_NOT_APPLY = "ERROR_WECHAT_PAY_REFUND_NOT_APPLY";
    public static final String ERROR_WECHAT_PAY_DOWNLOAD_BILL_EXIST = "ERROR_WECHAT_PAY_DOWNLOAD_BILL_EXIST";
    /**
     * 提现
     */
    public static final String ERROR_WECHAT_PAY_WITHDRAW_UNFINISH_WITHDRAW_EXIST = "ERROR_WECHAT_PAY_WITHDRAW_UNFINISH_WITHDRAW_EXIST";
    public static final String ERROR_WECHAT_PAY_WITHDRAW_WITHDRAW_APPLY_ORDER_EXIST = "ERROR_WECHAT_PAY_WITHDRAW_WITHDRAW_APPLY_ORDER_EXIST";
    public static final String ERROR_WECHAT_PAY_WITHDRAW_DUPLICATEPAID_ORDER_EXIST = "ERROR_WECHAT_PAY_WITHDRAW_DUPLICATEPAID_ORDER_EXIST";
    public static final String ERROR_WECHAT_PAY_WITHDRAW_NO_PAID_ORDERS = "ERROR_WECHAT_PAY_WITHDRAW_NO_PAID_ORDERS";
