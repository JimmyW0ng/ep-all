...
public class BizConstant {
    ...
    public static String WECHAT_XCX_TEMPLATE_NORMAL_CLASS_OPEN = "WECHAT_XCX_TEMPLATE_NORMAL_CLASS_OPEN";

    public static String WECHAT_XCX_TEMPLATE_BESPEAK_CLASS_OPEN = "WECHAT_XCX_TEMPLATE_BESPEAK_CLASS_OPEN";
