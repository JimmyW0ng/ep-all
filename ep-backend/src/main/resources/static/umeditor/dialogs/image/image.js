...
//                }
            ...
            callback: function (editor, $w, url, preCode, state) {

                if (state == "SUCCESS") {
                    //显示图片计数+1
                    Upload.showCount++;
                    var $img = $("<img src='" + editor.options.imagePath + url + "'name='" + preCode + "' class='edui-image-pic' />"),
    ...
    var Upload = {
        ...
        uploadComplete: function (r) {
            ...
            try {
                var json = eval('(' + r + ')');
                //modify by feicongcong
                Base.callback(me.editor, me.dialog, json.url, json.preCode, json.state);
            } catch (e) {
